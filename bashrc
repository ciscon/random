...
if [[ ${EUID} == 0 ]]; then
  PS1+='\[\033[00m\] \[\033[1m\]|\[\033[0m\] \[\033[31m\]\u\[\033[00m\]@\h $(__git_ps1 "\[\033[1m\]|\[\033[0m\] \[\033[31m\](%s) \[\033[0m\]")\[\033[1m\]|\[\033[0m\] \[\033[01;34m\]$(trimpath) \n\[\e[0;33m\]% \[\033[0m\]'
else
  PS1+='\[\033[00m\] \[\033[1m\]|\[\033[0m\] \[\033[32m\]\u\[\033[00m\]@\h $(__git_ps1 "\[\033[1m\]|\[\033[0m\] \[\033[31m\](%s) \[\033[0m\]")\[\033[1m\]|\[\033[0m\] \[\033[01;34m\]$(trimpath) \n\[\e[0;33m\]% \[\033[0m\]'
fi
