...
quakestat -timeout $timeout -maxsim 100 -qwm qwmaster.fodquake.net|grep -v 'no response' >> /tmp/quakeservers 2>/dev/null&
quakestat -timeout $timeout -maxsim 100 -qwm master.quakeservers.net|grep -v 'no response' >> /tmp/quakeservers 2>/dev/null&
